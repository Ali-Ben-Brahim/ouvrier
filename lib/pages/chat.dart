...
class _ChatState extends State<Chat> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) async {
      _token = await Provider.of<Auth>(context, listen: false).token;
      idUser = await Provider.of<Auth>(context, listen: false).user.id;
      if (mounted) {
...
//--------------------------------
  ...
  realTimeConversations(Timer t) async {
    try {
      List<ConversationModel> _conv =
          await Provider.of<ConversationProvider>(context, listen: false)
              .conversations;
      var conversationsUpdated =
          _conv.firstWhere((element) => element.id == widget.conversation.id);
      setState(() {
